    ...
    <section>
      <div className="container">
        <div className="max-w-[770px] w-full mx-auto ">
              ...
              <div className="grid grid-cols-2 gap-[24px]">
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2">
                  <p className="mb-0 w-[50%]">
                    Have you taken a test from a designated testing agency to
                    assess your proficiency in English or French?{" "}
                  </p>
          ...
          <div className="bg-white shadow-[0px_4px_18px_0px_rgba(0,0,0,0.10)] rounded-md mb-6">
            <div className="p-6">
              <h4 className="mb-6">Admissibility Details</h4>
              <div className="grid grid-cols-2 gap-[24px]">
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    ...
                    had tuberculosis of the lungs or been in contact with a
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    Do you have any physical or mental disorder that would
                    require social and/or health services, other than
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    ...
                    authorization in Canada? Keep in mind that if you ever had
                    to restore your status in Canada, then the answer to this
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    Have you ever applied for OR been refused refugee status in
                    ANY country?
                  </p>
                  <div className="w-[30%] flex justify-end">
                    <Checkbox.Group
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    Have you ever applied for OR been refused a permanent
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    Have you ever applied for OR been refused a visitor or
                    temporary resident visa in ANY country?
                  </p>
                  <div className="w-[30%] flex justify-end">
                    <Checkbox.Group
                      options={plainOptions2}
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    Have you ever applied for OR been refused a work permit in
                    ANY country?
                  </p>
                  <div className="w-[30%] flex justify-end">
                    <Checkbox.Group
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    Have you ever applied for OR been refused a study permit in
                    ANY country?
                  </p>
                  <div className="w-[30%] flex justify-end">
                    <Checkbox.Group
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    Have you ever applied for OR been refused for ANY other type
                    of visa, permit, etc. than those listed above, in ANY
                    country?
                  </p>
                  <div className="w-[30%] flex justify-end">
                    <Checkbox.Group
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    ...
                    border and not allowed to enter), or ordered to leave,
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    ...
                    could mean arriving at a border (land or airport) and not
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    Did you ever serve in any military, militia, or civil
                    defense unit or serve in a security organization or police
                    force (including non-obligatory national service, reserve or
                    volunteer units?
                  </p>
                  <div className="w-[30%] flex justify-end">
                    <Checkbox.Group
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    Are you, or have you ever been, a member or associated with
                    any political party, or other group or organization which
                    has engaged in or advocated violence as a means to achieving
                    a political or religious objective, or which has been
                ...
                <div className="w-full flex items-start justify-between gap-5 col-span-2 border-b pb-5">
                  <p className="mb-0 w-[70%]">
                    ...
                    of prisoners or civilians, looting or desecration of
                    religious buildings?
                  </p>
                  <div className="w-[30%] flex justify-end">
                    <Checkbox.Group
